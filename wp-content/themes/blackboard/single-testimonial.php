...
<div id="content">
	...
	if (isset($post_meta['academia_testimonial_author'][0])) { $testimonial_author = get_post_meta($post->ID, 'academia_testimonial_author', true); }
	if (isset($post_meta['academia_testimonial_date'][0])) { $testimonial_date = get_post_meta($post->ID, 'academia_testimonial_date', true); }
	endwhile;
	?>
			...
			<div class="academia-column academia-column-double academia-column-inside">
				...
				<div class="academia-column-wrapper">
					...
					<div class="post-meta-single">
						...
						<?php if (isset($testimonial_author) || isset($testimonial_date)) { ?>
						<p class="post-meta">
						<?php if (isset($testimonial_author)) { ?><span class="author"><?php echo $testimonial_author; ?></span> - <?php } ?>
						<?php if (isset($testimonial_date)) { ?><span class="datetime"><?php echo $testimonial_date; ?></span><?php } ?>
						</p>
						<?php } ?>
					</div><!-- .post-meta -->
