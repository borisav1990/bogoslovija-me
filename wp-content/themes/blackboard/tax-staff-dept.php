<div class="widget widget_nav_menu">
	<p class="title-s title-widget title-widget-gold"><?php _e('Staff Departments','academia_textdomain'); ?></p>
	
	<?php

	$args = array( 'taxonomy' => 'staff-dept', 'orderby' => 'name', 'order' => 'ASC', 'hide_empty' => 1 );
	$terms = get_terms('staff-dept', $args);
