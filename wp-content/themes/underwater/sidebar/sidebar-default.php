...
?>	
	...
	<p>Designed by <a href="http://www.bramblingdesign.com">Brambling Design</a> | &copy; Copyright <?php echo date("Y") ?> <a href="<?php bloginfo('url') ?>/" title="Home" rel="home"><?php bloginfo('name') ?></a></p>
