			...
			<div class="academia-column academia-column-double academia-column-inside">
				...
				<div class="academia-column-wrapper">
					...
					<div class="post-meta-single">
						...
						<p class="post-meta"><time datetime="<?php the_time("Y-m-d"); ?>" pubdate><?php the_time(get_option('date_format')); ?></time> <?php _e('in','academia_textdomain'); ?> <span class="category"><?php the_category(', '); ?></span></p>
					</div><!-- .post-meta -->
